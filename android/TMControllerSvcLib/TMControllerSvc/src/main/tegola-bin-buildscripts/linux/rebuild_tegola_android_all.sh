...
for index in ${!t_platform[*]} ; do
    ...
    eval "${MY_ANDROID_STUDIO_WORKSPACE}/src/github.com/terranodo/tegola-mobile/android/ControllerLib/Controller/src/main/tegola-bin-buildscripts/linux/clean_tegola.sh -t_platform ${t_platform[$index]} $REQUIRED_ARGS"
    eval "${MY_ANDROID_STUDIO_WORKSPACE}/src/github.com/terranodo/tegola-mobile/android/ControllerLib/Controller/src/main/tegola-bin-buildscripts/linux/build_tegola.sh -t_platform ${t_platform[$index]} $COMMON_ARGS"
    echo
done
